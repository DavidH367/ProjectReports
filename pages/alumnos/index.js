                        ...
                        <div className="">
                            ...
                            >
                                <ModalContent>
                                    {() => (
                                        <>
                                            <ModalHeader className="text-center flex flex-col gap-1">Actualizar Info Alumno</ModalHeader>
                                            <ModalBody>
                                                <div className="grid gap-1 grid-cols-1">
                                                    {errorMessage && (
                                ...
                                <Card isFooterBlurred className="w-52 h-full col-span-12 sm:col-span-5">
                                    ...
                                    <CardFooter className="absolute bg-white/30 bottom-0 border-t-0 border-zinc-100/50 z-10 grid justify-items-center text-center">
                                        <div>
                                            ...
                                            <p className="text-black text-tiny font-bold "> Born: {formatDate2(alumno.date)}</p>
                            ...
                            <>
                                ...
                                <ModalBody>
                                    ...
                                    <div className="grid gap-1 grid-cols-1 text-center justify-items-center">
                                        ...
                                        <Chip size="sm">Full Name: {selectedAlumno.firstname} {selectedAlumno.lastname}</Chip>
                                        ...
                                        <Chip size="sm">Fecha de Nacimiento: {selectedAlumno.date}</Chip>
